...
<?php else: ?>
    <?php foreach ($emails as $email): ?>
        <div class="email-event">
            ...
            <span><?= $this->url->icon('trash', '', 'EmailViewController', 'delete', array('plugin' => 'kbphpimap', 'mail_id' => $email['mail_id'], 'task_id' => $email['task_id'], 'project_id' => $email['project_id'])) ?></span>
            <br>
